...
```bash
bash "$HOME/Downloads/Moses_OneClick_Tool_V7.2.3/Moses_OneClick_Tool_Setup_V7.2.3.sh"
```

### Option 2 — Right-click → Run in Konsole

1. Right-click `Moses_OneClick_Tool_Setup_V7.2.3.sh`
...
```bash
bash "$HOME/Downloads/Moses_OneClick_Tool_V7.2.3/Moses_OneClick_Tool_Uninstall_V7.2.3.sh"
```
